...
const CONTROLLERS = [
  { num: 1, code: "ctrl-1", title: "РСО" },
  { num: 2, code: "ctrl-2", title: "ДМБ" },
  { num: 3, code: "ctrl-3", title: "Корпус 8 рядов" },
  { num: 4, code: "ctrl-4", title: "Телятник" },  
  { num: 5, code: "ctrl-5", title: "Нетелиный корпус" },
  { num: 6, code: "ctrl-6", title: "Профилакторий" },
];
